...
function geoFail() {
    ...
    $("body").prepend('<div class="location-search"><h1>Let us help you find your local weather!</h1><span><input type="text" name="input-field" autofocus placeholder="Khayelitsha or Cape Town"><button type="button" name="search"><i class="fa fa-search" aria-hidden="true"></i> Get Weather</button></span></div>');
